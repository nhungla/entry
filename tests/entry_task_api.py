...
class MediaSmokeTest(unittest.TestCase):
	def test_upload_image(self):
		with open("some_image.jpg", "rb") as image_file:
			image_encode = base64.b64encode(image_file.read())
		result_code, _ = request_service_api(MEDIA_UPLOAD_IMAGE, {"image_content": image_encode.decode(), "image_name": "some_image.jpg"}, access_token)
		self.assertEqual(result_code, Result.SUCCESS)
